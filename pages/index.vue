...
<template>
  ...
  >
    <div
      class="px-4 sm:pl-4 md:pl-20 xl:pl-20 pt-20 sm:pt-20 md:pt-0 xl:pt-0 flex flex-col space-y-3 w-[100vw] sm:w-[100vw] md:w-[50%] xl:w-[50%]"
    >
      <h1
        class="text-white text-[34px] sm:text-[34px] md:text-[46px] xl:text-[46px] leading-[36px] sm:leading-[46px] md:leading-[56px] xl:leading-[56px] font-medium font-['Overpass'] mt-10"
      >
        Orzularingiz orzuligicha qolmaydi. Endi
        <span
          class="text-cyan-400 text-[34px] sm:text-[34px] md:text-[46px] xl:text-[56px] font-medium font-['Overpass']"
          >Suniy Ai</span
        >
      ...
      <div
        class="w-[90vw] sm:w-[90vw] md:w-[50%] xl:w-[50%] h-0.5 bg-gradient-to-r from-cyan-400 to-cyan-800"
      ></div>
    ...
    <NuxtImg
      src="/HomeHande.svg"
      class="w-[100vw] sm:w-[100vw] md:w-[50%] xl:w-[50%] mt-5"
    />
  </section>
  <section
    id="about"
  ...
  >
  <div class="flex justify-end ml-1 sm:ml-1 md:ml-8 xl:ml-8 w-[90vw] sm:w-[90vw] md:w-[50%] xl:w-[50%] ">
    <NuxtImg
      src="/about.png"
      class="w-[90%] h-[450px]"
    />
  ...
  >
    ...
    <div class="flex justify-center flex-wrap">
      ...
      >
        ...
        <p
          class="text-white text-opacity-90 text-xl font-normal font-['Inter'] leading-[30px] tracking-wider"
        >
          {{ item?.text }}
        </p>
      </div>
  ...
  <section
    id="partfoliyo"
    class="p-2 sm:p-2 md:p-12 xl:p-12 bg-[#1E212C] h-fit"
  >
    <div
    ...
    <div
      class=" flex justify-center flex-wrap space-x-2 space-y-4 sm:space-y-4 md:space-y-0 xl:space-y-0 px-2 sm:px-2 md:px-10 xl:10 "
    >
      <div
      v-for="item in partfoliyo" :key="item.title"
        class="w-[300px] rounded-xl overflow-hidden border border-gray-600"
      >
      <div class="h-[200px]">
